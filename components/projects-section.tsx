    ...
    <div className="flex flex-col gap-12">
      ...
      <div className="flex flex-col gap-6">
        ...
        {projects.map((project) => (
          ...
          <div
            key={project.id}
            className="group relative rounded-lg border border-border/60 bg-card/50 p-6 lg:p-8 transition-all duration-300 glow-border-hover"
          >
            ...
            <div className="flex items-start justify-between gap-4">
              ...
              <div className="flex-1">
                <h3 className="text-lg font-semibold tracking-tight font-mono text-card-foreground transition-colors duration-300 group-hover:text-primary">
                  {project.title}
                </h3>
